...
@Component({
  ...
  providers: [AuthorsService, BooksService, MusicService, HTTP_PROVIDERS, ROUTER_PROVIDERS, provide(LocationStrategy, { useClass: HashLocationStrategy })],
...
export class AppComponent{
  constructor(router, authorsService, booksService, musicService){
  ...
  static get parameters() {
    return [[Router], [AuthorsService], [BooksService], [MusicService]];
  }
